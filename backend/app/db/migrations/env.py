...
# we're appending the backend directory to our path here so that we can import config easily
sys.path.append(str(pathlib.Path(__file__).resolve().parents[4]))

from backend.app.core.config import DATABASE_URL, POSTGRES_DB  # noqa
